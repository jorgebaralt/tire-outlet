...
class Home extends Component {
	...
	renderSnap = () => (
			<Row style={{ marginLeft: '2%', marginRight: '2%' }}>
				<Col
					m={24}
					style={{ marginTop: '2.5%', width: '100%', height: 'auto' }}
				>
					...
					<Row>
						<Col xl={12}>
							<h4 className="snap-list">
								<span className="snap-bold">Financing with Snap!</span> Up to
								80% Approval Rate
							</h4>
							<h4 className="snap-list">
						...
						<Col xl={12}>
							<h4
								className={
									this.state.width >= 1200
										? 'snap-list text-right'
										: 'snap-list'
								}
							>
								<span className="snap-bold">Apply Today</span> Bad Credit or
								No Credit? is OK!
							</h4>
							<h4
								className={
							...
							>
								<span className="snap-bold">Buy today</span>. Pay over 12
								months!
							</h4>
						</Col>
					</Row>
