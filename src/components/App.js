			...
			<Layout>
				...
				>
					...
					<Menu
						...
						defaultOpenKeys={[]}
						onClick={({ key }) => this.props.selectMenuOption(key)}
					>
						<Menu.Item key="Home">
							<Link to="/" className="menu-link">
								<Icon type="home" />
								<span className="nav-text menu-title">Home</span>
							</Link>
						</Menu.Item>
...
<span>
				...
				<Layout style={layoutStyle}>
					...
					<Footer style={footerStyle}>
						...
						<a href="https://www.freepik.com/free-vector/car-repair-icons_1011157.htm">
